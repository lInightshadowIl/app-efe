...
self.addEventListener('fetch', (event) => {
    ...
    // Archivos de app (HTML, JS, CSS): Network First
    // Siempre intenta la red primero, cache solo si estas offline
    if (
    ...
    // Iconos y assets estaticos: Cache First (no cambian frecuentemente)
